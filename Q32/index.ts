...
let currentUsers = ["Anus", "Hamza", "Bilal", "Hasseb", "Usman", "Ali"]
let newUsers = ["Shoaib", "Hamza", "Hasnen", "Ali", "Usama", "Abdullah"]
         
for (let i=0; i<newUsers.length; i++) {
    let filterName = currentUsers.filter((value)=> value==newUsers[i])  
    if(typeof filterName[0]== "string"){
        console.log(`${filterName[0]}  username has already been used. Please enter different name`);
    }
}
